...
- **What the lower bound accounts for:** _The lower bound accounts for the smallest fuel_cost that exists on a recursion branch _
- **Why it never overestimates:** _It can never overestimate because a lower bound ensures the logic of the minimum cost on a branch._
